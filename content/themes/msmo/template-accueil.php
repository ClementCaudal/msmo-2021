    ...
    <div class="carousel-home-container mb-4">
        <div id="carousel-home-slider" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <a href="#" class="carousel-item active" data-slide="{{ slide.numberSlide }}" data-position="{{ slide.position }}">
...
<!--                {% set index_slide = 1 %}-->
<!--                {% for slide in slides|sort((a, b) => a.numberSlide <=> b.numberSlide) if ((slide.dateStart|date("Y/m/d") <= "now"|date("Y/m/d")) and (slide.dateEnd|date("Y/m/d") >= "now"|date("Y/m/d"))) %}-->
                <li class="carousel-nav-item-container active" data-target="#carouselSlider" data-slide-to="{{ slide.numberSlide }}" data-position="{{ slide.position }}">
                    <p class="carousel-nav-item-title">Plannings</p>
                    <div class="carousel-nav-item-content">
                        <p>Plannings<br>du 03-04 Octobre 2021</p>
                    </div>
                </li>
                <li class="carousel-nav-item-container" data-target="#carouselSlider" data-slide-to="{{ slide.numberSlide }}" data-position="{{ slide.position }}">
